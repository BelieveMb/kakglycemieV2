      ...
      <div class="  w-full text-center  ">
        ...
        <div class=" flex-col justify-center hidden mySlides fade  h-auto w-full bg-no-repeat bg-cover bg-center py-40 " style="background-image: url('{{ asset('images/patient_kak.jpg') }}');">
          ...
          <div class="flex flex-col space-y-4 mx-20 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 lg:mx-0">
            <a href="{{ route('registerVue') }}" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-red-500 hover:bg-red-800 focus:ring-4 focus:ring-red-300">
              S'inscrire
            ...
            <a href="{{ route('loginUserVue') }}" class="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
              Se connecter
            </a>
          </div>
        </div>
      ...
      <div class="px-8 py-8 lg:px-40 lg:py-20  border-t border-b  rounded-b-xl  bg-opacity-10">
              ...
              <div class="w-full bg-gray-700 shadow-xl shadow-red-100 rounded-b-xl flex items-center
                flex-col gap-4 py-6 px-8 lg:flex-row lg:py-10 lg:px-10 lg:justify-between">
                    ...
                    <a href="{{ route('registerVue') }}"  class="px-5 py-3  font-medium text-gray-100 shadow-xl  hover:bg-white duration-150 hover:text-gray-700  bg-red-400 rounded-md">Rejoins nous </a >
              </div>
      </div>
    </section>
    
    <!-- components our doctors  -->
    @include('AllUsers.components.doctorsList')
    <!-- components our doctors  -->
              ...
              <div class="flex flex-col items-center justify-between lg:flex-row ">
                  <div class="lg:max-w-xl  relative z-40">
                      ...
                      <div class="mt-10 flex flex-col items-center md:flex-row">
                          <a href="{{route ('registerVue')}}" class="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-red-500 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-gray-600 focus:outline-none md:mr-4 md:mb-0 md:w-auto"> S'inscrire</a>
                          <a href="{{route ('loginUserVue')}}" aria-label="" class="group inline-flex items-center font-semibold text-g1"> Se connecter
