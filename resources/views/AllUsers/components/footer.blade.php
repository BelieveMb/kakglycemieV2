            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:gap-8       lg:grid-cols-4">
                ...
                <div class="sm:col-span-2">
                  ...
                  <ul class="text-gray-50 text-xl my-4 flex gap-4">
                    <li><a href="tel:+33615175061"><i class="bi bi-telephone"></i></a></li>
                    <li><a href="mailto:djokiam@gmail.com"><i class="bi bi-envelope"></i></a></li>
                    <li><a href=""><i class="bi bi-facebook"></i></a></li>
                    {{-- <li><a href=""><i class="bi bi-instagram"></i></a></li> --}}
                    <li><a href="wa.me/33615175061"><i class="bi bi-whatsapp"></i></a></li>
                  </ul>
              </div>
            </div>
