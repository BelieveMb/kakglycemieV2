...
<nav class="bg-red-500 border-b border-gray-100 fixed z-30 w-full">
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
         <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
               ...
               <a href="{{ route('Patient.dashboardForm') }}" class="text-xl font-bold flex items-center lg:ml-2.5">
            ...
            <div class="flex items-center">
               <button id="toggleSidebarMobileSearch" type="button" class="lg:hidden text-gray-500 hover:text-gray-900 hover:bg-gray-100 p-2 rounded-lg">
                  <span class="sr-only">Trouvez un médecin...</span>
               ...
               <a href="{{ route('Patient.logoutPatient') }}" class="hidden sm:inline-flex ml-5 text-red-500 bg-gray-100 hover:bg-gray-500 hover:text-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
