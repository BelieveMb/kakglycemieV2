        ...
        <div class="py-1 px-2 w-[96%] lg:w-[60%] min-h-screen bg-gray-300/30 rounded-lg border-2 shadow-md p-2 lg:p-8 ">
            ...
            <div class="flow-root">
                <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <h3 class="font-semibold text-xl animate-pulse delay-600 hover:text-red-400 ">Votre profil est incomplet. Merci de compléter votre inscription ici pour valider votre candidature. Cliquez sur 
                        <a href="{{ route('Medecin.monProfil') }}" class=" text-red-500 font-normal text-base  rounded-lg flex items-center p-2 group">
