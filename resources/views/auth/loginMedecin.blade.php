...
@section('loginType')
    <form method="POST" action="{{ route('medecin.loginDoctor') }}">
        ...
        <div class="flex flex-col gap-2">
            <div class="w-full px-3 mb-5">
                ...
                <div class="flex">
                    ...
                    <input type="tel"
                        ...
                        placeholder="Votre numéro de téléphone" name="telMed" :value="{{ old('telMed') }}" autofocus
                        autocomplete="telMed">
                </div>
                @error('telMed')
                    {{ $message }}
            ...
            <div class="w-full px-3 mb-5">
                <label for="password" class="text-xs font-semibold px-1" :value="__('password')">Mot de
                    passe </label>
                <div class="flex">
                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                    ...
                    <input type="text"
                        class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                        placeholder="Votre mot de passe" name="password" autofocus autocomplete="password">
                </div>
        ...
        <div class="px-5 flex items-center">
            <p>Pas de compte sur KaK glycémie, <a href="{{ route('register') }}" class="text-red-400 underline">S'inscrire
