                ...
                <div>
                    ...
                    <div class="flex flex-row gap-3">
                        <div class="w-1/2 px-3 mb-5">
                            <label for="nomMed" class="text-xs font-semibold px-1">Nom complet</label>
                            <div class="flex">
                    ...
                    <div class="flex flex-row gap-3">
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Votre mot de passe" name="motdepasse" :value="old('motdepasse')" required autofocus autocomplete="motdepasse" >
                            </div>
                    ...
                    <div class="flex flex-row gap-3">
                        <div class="w-1/2 px-3 mb-5">
                            <label for="infosMed" class="text-xs font-semibold px-1" :value="__('infosMed')">Infos Médecin </label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="bi bi-lock text-gray-400 text-lg"></i></div>
                                <textarea name="infosMed"  class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"   placeholder="Votre mot de passe" :value="old('infosMed')" required autofocus autocomplete="infosMed" >
                                </textarea>
                            </div>
                            <x-input-error :messages="$errors->get('infosMed')" class="mt-2" />
                        </div>
