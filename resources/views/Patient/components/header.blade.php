            ...
            <div class="flex items-center justify-start">
               ...
               <form action="#" method="GET" class="hidden lg:block lg:pl-32">
                  ...
                  <div class="mt-1 relative lg:w-64">
                     ...
                     <input type="text" name="email" id="topbar-search" class="bg-red-200 border border-gray-400  text-gray-900 sm:text-sm rounded-lg hover:bg-gray-100 focus:ring-cyan-600 focus:border-cyan-600 block w-full pl-10 p-2.5" placeholder="Search">
                  </div>
               </form>
            </div>
