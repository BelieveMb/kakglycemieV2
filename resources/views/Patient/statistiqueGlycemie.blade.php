                                ...
                                <div class="max-w-2xl mx-auto my-4">
                                    <form  class="flex items-center" method="POST" action="{{ route('Patient.statistiqueGlycemie') }}">   
                                        ...
                                        <div class="relative w-full">
                                            ...
                                            <input type="date" id="dateTrait" name="searchDate"  class="bg-gray-200 border border-gray-300 text-gray-700 outline-none text-sm rounded-lg hover:border-red-500 focus:ring-red-500 focus:border-red-500 block w-full pl-10 p-2.5  " placeholder="Trouvez une date de traitement..." required>
