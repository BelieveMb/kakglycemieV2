                                ...
                                <div class="max-w-2xl mx-auto my-4">
                                    ...
                                    {{-- method="POST" action="{{ route('Patient.statistiqueGlycemie') }}" --}}
                                        ...
                                        <div class="relative w-full">
                                            ...
                                            <input type="date" id="dateTraitement" name="dateTraitement"  class=" bg-gray-200 border border-gray-300 text-gray-700 outline-none text-sm rounded-lg hover:border-red-500 focus:ring-red-500 focus:border-red-500 block w-64 pl-10 p-2.5  "
