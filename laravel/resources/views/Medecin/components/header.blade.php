      ...
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
         <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
               ...
               <a href="{{ route('logoutUser') }}" class="hidden sm:inline-flex ml-5 text-red-500 bg-gray-100 hover:bg-red-500 hover:text-gray-50 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
