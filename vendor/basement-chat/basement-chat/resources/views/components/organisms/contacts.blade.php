...
>
    <x-basement::organisms.header class="bm-z-30">
        <x-slot:title>
            <x-basement::atoms.icons.fas-comments class="bm-my-1 bm-inline bm-w-4" /> KaK Messages
        </x-slot:title>

        <x-slot:buttons>
            <x-basement::atoms.buttons.header
                data-title="Désactiver les notifications"
            ...
            <x-basement::atoms.buttons.header
                data-title="Configure votre navigateur pour accepter les notifications"
    ...
    >
        ...
        <x-basement::molecules.form-group class="bm-relative bm-col-span-full bm-block bm-py-4">
            <x-slot:title>Trouvez les médecins</x-slot:title>
            <x-slot:icon>
            ...
            <x-basement::atoms.input
                ...
                x-model="search"
                autocomplete="off"
                placeholder="Trouvez un médecin"
            />
                    ...
                    <div class="bm-grid bm-grid-cols-4">
                        <p class="bm-col-span-3 bm-truncate bm-text-sm">
                            ...
                            <template x-if="contact.typing === true">
                                <span x-bind:data-title="`${contact.name} est entrain d'écrire ...`">
                                    <span
                        ...
                        <p class="bm-col-span-1 bm-text-right">
                            <span
                                ...
                                x-bind:data-title="`Il y'a ${contact.unreadMessages} messages non lu`"
                            ></span>
                        </p>
                    </div>
                </div>
