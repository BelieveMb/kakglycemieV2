              ...
              <div>
                ...
                <div class="flex flex-wrap flex-col align-center w-full gap-8 lg:flex-row  lg:align-start">
                  ...
                  <div class="flex flex-col mr-5 text-center mb-11   ">
                    <div class="inline-block mb-4 relative shrink-0 rounded-[.95rem]">
                      <img class="inline-block shrink-0 rounded-[.95rem] w-[150px] h-[150px] shadow-red-200 shadow-lg"
                      src="../images/img_avantage.png" alt="avarat image">
                    </div>
                    <div class="text-center">
                      <a href="javascript:void(0)" class="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">Samantha Reynolds</a>
                      <span class="block font-medium text-red-300">Marketing Manager</span>
...
<section class="bg-gray-700 px-8 py-10  lg:px-40 lg:py-20 ">
  <div
    class="relative flex-[1_auto] flex flex-col break-words min-w-0 bg-clip-border rounded-[.95rem] border border-dashed border-stone-200 bg-white ">
    <div class="flex-auto block py-2 px-8">
      <h3 class="mb-2 text-[2rem] font-semibold text-gray-700">Nos Médecins </h3>
      <div id="default-carousel" class="relative w-full" data-carousel="slide">
              ...
              <div class="flex flex-col mr-5 text-center mb-11   ">
                ...
                <div class="text-center">
                  <a href="javascript:void(0)"
                    class="text-dark font-semibold hover:text-primary text-[1.25rem] transition-colors duration-200 ease-in-out">1
                    Reynolds</a>
                  <span class="block font-medium text-red-300">Marketing Manager</span>
                </div>
              </div>
        ...
        <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
          <button type="button" class="w-3 h-3 rounded-full text-gray-700" aria-current="true" aria-label="Slide 1"
        ...
        <button type="button"
          ...
          data-carousel-next>
          <span
            class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-red-500 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
            <svg class="w-4 h-4 text-gray-800 rtl:rotate-180" aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="m1 9 4-4-4-4" />
